...
- **Exportações de segmento** permitem exportar entidades de segmento do Customer Insights. Os segmentos representam uma lista de perfis de clientes. Ao configurar a exportação, você seleciona os campos de dados incluídos, dependendo do sistema de destino para o qual você está exportando os dados. 
